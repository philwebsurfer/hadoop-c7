...
echo 'docker run --rm -p 2222:22   --memory=16g --cpu-period="100000"  --cpu-quota="400000" -v /sys/fs/cgroup:/sys/fs/cgroup:ro -v ~/dfs_n2:/dfs --hostname av175875 --network host --rm -it philwebsurfer/xenial-hadoop-base:2.8.3'
echo 'docker run --rm -p 2222:22   --memory=16g --cpu-period="100000"  --cpu-quota="400000" -v /sys/fs/cgroup:/sys/fs/cgroup:ro -v ~/dfs_n3:/dfs --hostname em175921 --network host --rm -it philwebsurfer/xenial-hadoop-base:2.8.3'
echo
...
echo 'docker run --rm -p 2222:22   --memory=16g --cpu-period="100000"  --cpu-quota="400000" -v /sys/fs/cgroup:/sys/fs/cgroup:ro -v ~/dfs_n2:/dfs --hostname av175875  --rm -it philwebsurfer/xenial-hadoop-base:2.8.3'
echo 'docker run --rm -p 2222:22   --memory=16g --cpu-period="100000"  --cpu-quota="400000" -v /sys/fs/cgroup:/sys/fs/cgroup:ro -v ~/dfs_n3:/dfs --hostname em175921  --rm -it philwebsurfer/xenial-hadoop-base:2.8.3'
